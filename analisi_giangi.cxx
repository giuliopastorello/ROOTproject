...
/*void verifica()
{
  ...
  TH1F *particlesHisto = (TH1F *)file->Get("h1");
  TH1F *phiHisto = (TH1F *)file->Get("h2");
  TH1F *thetaHisto = (TH1F *)file->Get("h3");
  TH1F *impulseHisto = (TH1F *)file->Get("h4");
  TH1F *transverseImpulseHisto = (TH1F *)file->Get("h5");
  TH1F *energyHisto = (TH1F *)file->Get("h6");

  TH1F *mass1Histo = (TH1F *)file->Get("h8");
  TH1F *mass2Histo = (TH1F *)file->Get("h9");
  TH1F *mass3Histo = (TH1F *)file->Get("h10");
  TH1F *mass4Histo = (TH1F *)file->Get("h11");
  TH1F *mass5Histo = (TH1F *)file->Get("h12");
  TH1F *mass6Histo = (TH1F *)file->Get("h7");
